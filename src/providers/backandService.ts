...
export class BackandService {
  ...
  private app_name:string = 'pillpal';
  private signUpToken: string = 'd81c9627-821c-4283-90b4-69d4da97fbbf';
  private anonymousToken: string = '88bfd02b-0364-4e43-9f14-247e56208dec';
